...
cat AP.dat | awk '{if(NR%20==1) print $1,$2}' | awk '{if(NR<11) print}' > AP1.dat
cat ina.dat | awk '{if(NR%20==1) print $1,$2}' | awk '{if(NR<11) print}' > ina1.dat
cat ical.dat | awk '{if(NR%20==1) print $1,$2}' | awk '{if(NR<11) print}' > ical1.dat
cat ikr.dat  | awk '{if(NR%20==1) print $1,$2}' | awk '{if(NR<11) print}' > ikr1.dat
cat iks.dat | awk '{if(NR%20==1) print $1,$2}' | awk '{if(NR<11) print}' > iks1.dat
cat ik1.dat | awk '{if(NR%20==1) print $1,$2}' | awk '{if(NR<11) print}' > ik11.dat
cat ito.dat | awk '{if(NR%20==1) print $1,$2}' | awk '{if(NR<11) print}' > ito1.dat
