...
cat ./0D1-0/data.out | awk '{print ($2-92000)/1000,$4*1000}' > cont.dat
cat ./0D1-1/data.out | awk '{print ($2-92000)/1000,$4*1000}' > cont1.dat
cat ./0D1-2/data.out | awk '{print ($2-92000)/1000,$4*1000}' > cont2.dat
