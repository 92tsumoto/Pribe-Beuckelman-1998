...
cat ./Endo_data/current.out | awk '{print ($1-29000),$7}' > cont.dat
cat ./Mid_data/current.out | awk '{print ($1-29000),$7}' > cont1.dat
cat ./Epi_data/current.out | awk '{print ($1-29000),$7}' > cont2.dat
