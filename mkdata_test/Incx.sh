...
cat ./Endo_data/current.out | awk '{print ($1-29000),$10}' > cont.dat
cat ./Mid_data/current.out | awk '{print ($1-29000),$10}' > cont1.dat
cat ./Epi_data/current.out | awk '{print ($1-29000),$10}' > cont2.dat
