...
cat ./0D1-0/ikr.out | awk '{print ($1-92000)/1000,$2}' > cont.dat
cat ./0D1-1/ikr.out | awk '{print ($1-92000)/1000,$2}' > cont1.dat
cat ./0D1-2/ikr.out | awk '{print ($1-92000)/1000,$2}' > cont2.dat
